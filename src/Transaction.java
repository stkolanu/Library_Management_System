  ...
  //  int siid=Integer.parseInt(s4);
	...
	{   try {
		 Class.forName("com.mysql.jdbc.Driver");
		  ...
		  statement3=con.prepareStatement("select noBookIssued from student where suid="+Integer.parseInt(s4)+";");
		...
		int rand1=rand.nextInt(1000);
		  statement2=con.prepareStatement("update student set noBookIssued='"+ b +"'  where suid= "+Integer.parseInt(s4)+";");
