...
public void actionPerformed(ActionEvent e)
{
	...
	if(b1==e.getSource())
	{
		  try {
			 ...
			 PreparedStatement statement13 = con.prepareStatement("update books set status= '"+s6+"',fid=null"+",dateofpurchase=null"+" where bookid="+b+";");
			 statement13.executeUpdate();
			 PreparedStatement statement14 = con.prepareStatement("delete from transaction where fid="+Integer.parseInt(s4)+" and bid="+b+";");
